            ...
            <div className="w-full max-w-xl mx-auto py-10 sm:py-0">
              <div className="flex flex-col gap-6">
                ...
                <p className="font-albertSans text-base sm:text-lg leading-relaxed text-secondary">
                  <strong className="font-semibold">Wayanad, Kerala</strong>, is a
                  serene paradise nestled in the Western Ghats, renowned for its
                  lush green landscapes, misty hills, and rich biodiversity. This
                  enchanting destination offers a perfect blend of nature,
                  adventure, and culture, making it ideal for travelers seeking
                  tranquility and exploration. From sprawling tea and spice
                  plantations to pristine waterfalls and wildlife sanctuaries,
                  Wayanad captivates every visitor. Its charming villages,
                  historical sites, and vibrant local traditions add depth to the
                  experience. Whether you are trekking through dense forests,
